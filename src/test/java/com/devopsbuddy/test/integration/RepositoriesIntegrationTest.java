...
public class RepositoriesIntegrationTest {
    ...
    @Before
    public void init(){//Da se pobrinemo da nisu ove repozitoriji null prije pocetka testiranja da se provjeri
    ...
    private User createBasicUser(){
        ...
        user.setEmail("me@exaple.com");
        user.setFirstName("firstName");
        user.setLastName("lastName");
        user.setPhoneNumber("123456465135");
        user.setCountry("GB");
