...
public class ContactController {
    ...
    public String contactGet(ModelMap model){//Ovaj metod treba da napravim prazan feedBack POJO i postavi ga u model obj. kao par kljuc i vrijednost i vrati view contact/contact.
